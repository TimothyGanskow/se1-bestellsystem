...
//		/////////////////////////////////////////////
//		System.out.println( "\\\\\nInventory value: -------> "
//				+ pad( fmtPrice( inventoryValue(), "", " �" ), 14, true ) );
//		int topN = 10;
...
//	 */
//	
//	// 1. mit einer normalen Schleife
////	long inventoryValue() {
////			long value = 0;
////		for (int i = 0; i < catalog.size(); i++) {
////			value = value + catalog.get(i).getUnitPrice()*catalog.get(i).getUnitsInStore() ;	
////		}
...
//	long inventoryValue() {
//		long value = 0;
//	value = catalog.stream().map(a -> a.getUnitPrice()*a.getUnitsInStore()).collect(Collectors.summingLong(Long::longValue));
//	return value;			// value in Cent
//}
//	
//
...
//		 */
//		
//		// Ausgabe nach h�chstem Value
//		
//		List<Article> sortList = catalog.stream().
//				sorted(Comparator.comparingLong(Article::getValue).
//				reversed()).
...
//		List<Article> lessThan = catalog.stream().filter(a -> a.getUnitsInStore() <= units).collect(Collectors.toList());
//		return lessThan.stream();
//	}
//	
//
//	/**
...
//		List<Article> sorted = catalog.stream().sorted(Comparator.comparingLong(Article::getValue).reversed()).collect(Collectors.toList());
//		return sorted.stream().limit( 10 );
//	}
//
//
//
